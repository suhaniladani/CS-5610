...
export default function run_demo(root) {
  ReactDOM.render(<Demo width={4} height={4}/>, root);
}
...
class Demo extends React.Component {
  ...
  this.state={cards: cards, currentCardState: cardStates.WFFC, firstCard: null, secondCard: null};
...
var cards = generateArray(4, 4);
  ...
  render() {
    const cardsDepict = this.state.cards.map((rowOfCards, rowCounter)=><div className="row">{rowOfCards.map((card, indexOfCardInRow)=><div className="col-md cardCol">
    ...
    return (
      ...
      {cardsDepict}
      <div className="row">
        <div className="number-clicks"> <p>Number of clicks: <strong>{clicks}</strong></p> </div>
